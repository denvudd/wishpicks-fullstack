...
import { useButtonGroup } from '@nuxt/ui/composables/useButtonGroup'
import { formLoadingInjectionKey } from '@nuxt/ui/composables/useFormField'
import { omit, mergeClasses } from '@nuxt/ui/utils'
    ...
    >
      <slot name="leading">
        <template v-if="isLoading">
          <Transition name="wp-spinner" appear>
            <UIcon
              v-if="isLeading"
      ...
      <slot name="trailing">
        <template v-if="isLoading && isTrailing">
          <Transition name="wp-spinner" appear>
            <UIcon
        ...
        <UIcon
          v-else-if="!isLoading && isTrailing && trailingIconName"
          :name="trailingIconName"
          :class="ui.trailingIcon({ class: props.ui?.trailingIcon, active })"
        />
      </slot>
